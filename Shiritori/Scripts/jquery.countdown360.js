;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      ...
      strokeStyle: "#FE9A2E",     // the color of the stroke
      strokeWidth: undefined,     // the stroke width, dynamically calulated if omitted in options
      fillStyle: "#101907",       // the fill color
      fontColor: "#FE9A2E",       // the font color
  ...
  Plugin.prototype = {
    ...
    elapsed: function () {
        ...
        var dif = curr.getTime() - this.startedAt.getTime();

        var secondsRaw = dif / 1000;
        var elapsed = Math.floor(Math.abs(secondsRaw));
        return elapsed;
    },
